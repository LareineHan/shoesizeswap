...
})({"g4CTn":[function(require,module,exports) {
...
window.onload = function() {
    ...
    (0, _converterJs.populateSizes)(regions[0], "size-button"); // Default buttons for the first region
};
const targetRegionSelect = document.getElementById("target_region");
targetRegionSelect.addEventListener("change", function() {
    const selectedRegion = this.value;
    const sizes = (0, _converterJs.getSizesForRegion)(selectedRegion);
    console.log(sizes); // or perform any other desired action
    return sizes;
});

},{"./sizes.js":"gqr1V","./converter.js":"c4tuP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gkKU3":[function(require,module,exports) {
...
},{}]},["g4CTn","dV6cC"], "dV6cC", "parcelRequire8dbc")
